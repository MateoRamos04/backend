...
public class LiquidacionDTO {
    ...
    public static LiquidacionDTO fromEntity(LiquidacionEntity entity){
        return LiquidacionDTO.builder()
                .id(entity.getId())
                .numeroTarjeta(entity.getTarjeta().getNumero())
                .titular(entity.getTarjeta().getTitular())
                .anio(entity.getAnio())
                .mes(entity.getMes())
                .totalAPagar(entity.getTotalAPagar())
                .totalImpuestos(entity.getTotalImpuestos())
                .totalDescuentos(entity.getTotalDescuentos())
                .totalConsumos(entity.getTotalConsumos())
                .build();
    }
}