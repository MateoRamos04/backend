 ...
 * @version 2023
 */
public class ListaArrayIterable<E> implements Iterable<E> {
     ...
     */
    public ListaArrayIterable(int capacidad) {
        if (capacidad <= 0) {
            capacidad = 10;
        }
    ...
    public Iterator<E> iterator() {
        ...
        return new ListaArrayIterator<E>();
    }

    /**
     * Clase que implementa el iterador de la versión anterior pero de forma de poder tener tantos iteradores como haga
     * cada uno independiente de los demás.
     */
    private class ListaArrayIterator<E> implements Iterator<E> {
        ...
        /**
         * Indica si queda algún objeto en el recorrido del iterador.          *
         *
         * @return true si queda algún objeto en el recorrido - false si no
         * quedan objetos.
         */
        @Override
        ...
        public E next() {
            ...
            current++;
            next_ok = true;
            return (E) elementos[current];
        }

        /**
         * Elimina el último elemento que retornó el iterador. Debe invocarse
        ...
        public void remove() {
            ...
            E garbage = (E) ListaArrayIterable.this.quitar(current);
            next_ok = false;
            current--;
        }
    }
