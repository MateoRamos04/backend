 ...
 * Python). Se aplícó una estrategia de desarrollo basada en emular en lo
 ...
 * ya existente).
 * En esta versión final la clase ArrayList deriva de la
 ...
 * 
 * @author philip (basado en ejemplo de TSB de Valerio Frittelli).
 * @version 2023
